...
const AboutUs = ({onBack}: AboutUsProps) => {
  ...
  return (
    <div className="bg-wallpaper-about-us overflow-hidden absolute max-h-[100vh]">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col flex-grow md:flex-row justify-between items-center mb-6 ">
          <div className="w-[50%]">
            <Image src="/images/Jobhub Headshot.png" alt="About Us Image" className="border rounded-full mb-4" height="500" width = "500"/>
          </div>
          <div className="w-full p-2 overflow-auto max-h-[50vh] md:p-10 md:overflow-hidden md:max-h-[100vh]">
            <h1 className="md:text-2xl text-xl font-bold mb-4 text-center text-custom-black">Everything About Our Vision</h1>
            <p className="text-custom-white md:text-lg text-sm mb-4 text-center">
            ...
            <div className="flex justify-center items-center text-right space-x-6 ">
              ...
              <a href="https://github.com/jobless-devs/Jobhub" className="text-custom-black hover:text-custom-orange">
