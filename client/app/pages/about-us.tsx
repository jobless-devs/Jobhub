  ...
  return (
    <div className="bg-wallpaper-about-us">
      <div className="container mx-auto">
        <button onClick={onBack} className="bg-custom-black hover:bg-custom-orange text-center text-white p-2 rounded mt-3 ml-3 md:ml-0 justify-center mx-autos">&#5176; Back</button>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          <div className="w-[50%]">
            <Image src="/images/Jobhub Headshot.png" alt="About Us Image" className="border rounded-full" height="500" width = "500"/>
          </div>
          <div className="md:w-full p-10">
            <h1 className="md:text-2xl text-xl font-bold mb-4 text-center text-custom-orange">Everything About Our Vision</h1>
